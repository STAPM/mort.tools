...
author: "Duncan Gillespie, Laura Webster, Colin Angus"
date: "`r Sys.Date()`"
...
## Death microdata
\begin{itemize}
\item 326 lower tier Local Authorities
\item IMD quintiles
\item sex
\item Age groups single year of age then 100+ (in some years the data was provided with the upper open age-interval of 90+ due to small number counts to avoid being disclosive - so all our analyses use 90+)
\item ICD-Codes
\item 2001-latest available
\item Death Counts
\end{itemize}
...
\begin{itemize}
\item 326 lower tier LAs
\item IMD quintiles
\item sex
\item Age groups single year of age then 100+
\item 2001-latest available
\item Death Counts
\end{itemize}
...
```{r, eval = T, warning = F, out.extra='', echo=F, fig.width = 5, fig.height = 5, fig.cap = "Age-standardised rates of death from lung cancer per 100,000 people by quintiles of the English Index of Multiple Deprivation."}
...
```{r, eval = T, warning = F, out.extra='', echo=F, fig.width = 5, fig.height = 5, fig.cap = "Age-specific rates of death from lung cancer per 100,000 people in 2016 by sex and quintiles of the English Index of Multiple Deprivation."}
...
![Snapshot of the forecast input spreadsheet.](forecast_spreadsheet_snapshot.png)
...
```{r, eval = T, warning = F, out.extra='', echo=F, fig.width = 5, fig.height = 6, fig.cap = "Forecast of lung cancer death rates for males compared between the least and most deprived IMD quintiles."}
